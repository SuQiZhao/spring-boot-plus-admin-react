...
import findRoute, {
  getUrlQuery,
} from '/Users/xiaoshitou/Documents/GitHub/spring-boot-plus-admin-react/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/Users/xiaoshitou/Documents/GitHub/spring-boot-plus-admin-react',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
